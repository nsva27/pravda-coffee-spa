export const Footer = () => {
  return (
    <footer
      className="
        w-full sm:h-20 md:h-22 lg:h-25
    ...
    >
      <div className="flex gap-10 items-center">
        ...
        <div className="hidden sm:flex flex-col gap-y-0.5 select-none">
          ...
          <span className="text-[#323232] font-bold text-sm">
            &copy; 2019-2025
          </span>
          <span className="text-[#323232] font-bold text-sm">
            All Rights Reserved.
      ...
      <div className="relative flex flex-col md:gap-1.5 lg:gap-3">
        <a
          ...
          className="text-xs sm:text-sm md:text-xl lg:text-2xl font-bold text-[#4d4d4d]"
        >
          8 (991) 340-26-86
        </a>
        <a href="#" className=" hidden sm:block self-start">
          <span
            ...
            sm:font-medium md:font-bold text-[#323232]"
          >
            Мы на карте
          </span>
          <img
